...
import { ContainmentContext, SyllableGroupContext, SyllableGroupMultiContext, SyllableGroupSingleContext, TimeTaggedEmptyContext, TimeTaggedSyllableGroupContext } from "../../../../antlr/generated/MotorMusicParser";
...
export class ProcessedSyllableGroupData {
...
export class ContainingSyllableGroupData extends ProcessedSyllableGroupData {
...
export class PrepareProcessedSyllableGroupDataListener extends MotorMusicParserListener {
    ...
    syllableGroupMap : Map<SyllableGroupContext, ProcessedSyllableGroupData>;
    ...
    enterSyllableGroup = (ctx : SyllableGroupContext) => {
        if (!this.areCurrentSyllablesFromAContainmentGroup) {
            this.syllableGroupMap.set(ctx, new ProcessedSyllableGroupData());
